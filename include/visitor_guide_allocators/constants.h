...
static std::string const& VERY_LONG_STRING_1 =
  "Very looooooooooooooong string 1";
static std::string const& VERY_LONG_STRING_2 =
  "Very looooooooooooooong string 2";
static std::string const& VERY_LONG_STRING_3 =
  "Very looooooooooooooong string 3";
